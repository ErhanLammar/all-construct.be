...
Tags: widgets, siteorigin, siteorigin widgets bundle, siteorigin page builder, siteorigin addons, video background, portfolio, carousel
...
<li>Post Carousel Widget that displays your posts as a highly responsive carousel.</li>
...
<li>Portfolio widgets that displays portfolio entries in a nice responsive grid. Masonry and packed options are supported.</li>
...
If not using a page builder, you can wrap the widget with a div of class 'lsow-dark-bg' to invoke dark version. Make sure you set the appropriate dark background for the wrapper div.
...
2. Livemesh SiteOrigin Widgets in action in SiteOrigin Page Builder tab of Page Edit window.
